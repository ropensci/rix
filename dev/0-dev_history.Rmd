...
fusen::fill_description(
  ...
  fields = list(
    ...
    `Authors@R` = c(
      ...
      person("Philipp", "Baumann", email = "baumann-philipp@protonmail.com", role = "ctb", comment = c(ORCID = "0000-0002-3194-8975"))
    )
  )
)
...
rix(r_ver = "8ad5e8132c5dcf977e308e7bf5517cc6cc0bf7d8",
    ...
    git_pkgs = list(
      ...
      branch_name = "master",
      commit = "34f4715e7fa37748d3db047ce3b7f4dafe1da59c"
    ),
    ide = "other",
    path = ".",
    overwrite = TRUE)
