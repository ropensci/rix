---
title: "Advanced topic: Running R or Shell Code in Nix from R"
...
Let's start by building a subshell built using an arbitrary revision of `nixpkgs`:
...
load and tranform some data using `{arrow}`. It may look
something like this:
