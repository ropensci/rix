...
fetchgit <- function(git_pkg){
  ...
  if(is.null(sri_hash)){
    sri_hash <- get_sri_hash(repo_url, branchName, commit)
  } else {
    sri_hash <- sri_hash
  }
...
```
testthat::expect_equal(
            fetchgit(list(package_name = "housing",
...
#'   "package_name", "repo_url", "branchName" and "commit". A fifth, optional
#'   element, "sri_hash" can be provided as well.
