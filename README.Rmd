...
For isolation, `{rix}` includes a `rix_init()` function that creates a custom
.Rprofile. It prevents conflicts with library paths from system-installed R
versions, offering better control over your environment. `rix_init()` is called
