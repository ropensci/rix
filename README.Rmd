...
easily. Nix is available for Linux, macOS and Windows.
...
This call will generate a `default.nix` that installs R version 4.1.0, with the
...
the current version of R and install an old package.
...
```
nix-shell https://github.com/b-rodrigues/rix/tree/master/inst/extdata/default.nix
```
