# This file was generated by the {rix} R package v0.15.3 on 2025-03-01
# with following call:
# >rix(date = "2025-02-17",
#  > git_pkgs = list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "8c00d3cc3fe64758cd65f5dccce853bda97f1801"),
#  > ide = "none",
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-02-17.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "8c00d3cc3fe64758cd65f5dccce853bda97f1801";
        sha256 = "sha256-mr1cyARchxuCQGPO8/nVwbvw3xr6k1vWonQtlAIolXI=";
      };
