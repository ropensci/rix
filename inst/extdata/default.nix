# This file was generated by the {rix} R package v0.17.3 on 2025-10-27
# with following call:
# >rix(date = "2025-04-29",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "49783e1a8f95e8daf6d8e62a7d0873fea0f9d569"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-04-29.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "49783e1a8f95e8daf6d8e62a7d0873fea0f9d569";
        sha256 = "sha256-xiVNBA8+U8Vf5vq05qZ5oFqJhBOdXs+e4smamZHvhmU=";
      };
