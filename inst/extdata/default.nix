# This file was generated by the {rix} R package v0.16.1 on 2025-05-03
# with following call:
# >rix(date = "2025-04-29",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "7c037c46ac715462e7387797b63f3f59224d000a"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-04-29.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "7c037c46ac715462e7387797b63f3f59224d000a";
        sha256 = "sha256-2SCZ6wlSdwFZ3R/JKcQ6/XJPjZsXwuuE9UHi42pLf8E=";
      };
    ...
    rixpress = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "HEAD";
        sha256 = "sha256-N5rdbTCWQRcbWsVSuKtSwIhQlIjC8rF4B+XCAveAmgI=";
      };
      propagatedBuildInputs = builtins.attrValues {
        inherit (pkgs.rPackages) 
          igraph
