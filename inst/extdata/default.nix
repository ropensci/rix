# This file was generated by the {rix} R package v0.18.1 on 2026-01-28
# with following call:
# >rix(date = "2026-01-14",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "ac5310ecb240a1fd34074f80351af2fc5953f92a"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2026-01-14.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "ac5310ecb240a1fd34074f80351af2fc5953f92a";
        sha256 = "sha256-dOK+dZm+pTMaamH2VrLI/593FhlJyfMaP2AV+W91mXI=";
      };
