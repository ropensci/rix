# This file was generated by the {rix} R package v0.17.0 on 2025-09-02
# with following call:
# >rix(date = "2025-04-29",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "4c6ac770a95916959324fa61face016091593928"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-04-29.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "4c6ac770a95916959324fa61face016091593928";
        sha256 = "sha256-NqJgNlWBchYb1FX5CgeqpIYhyGN9UVZes5VZUX//fis=";
      };
