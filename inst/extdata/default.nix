# This file was generated by the {rix} R package v0.18.2 on 2026-04-26
# with following call:
# >rix(date = "2026-01-14",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "b38aadf4f5c23c41e0a8639d8d981dd742ca9691"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2026-01-14.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "b38aadf4f5c23c41e0a8639d8d981dd742ca9691";
        sha256 = "sha256-YydOs621Y5yV+efCZO+R+RrlU/GwAgPqHDNaGXxxARc=";
      };
