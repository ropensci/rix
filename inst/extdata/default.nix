# This file was generated by the {rix} R package v0.15.2 on 2025-02-19
# with following call:
# >rix(date = "2025-02-17",
#  > git_pkgs = list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "e14b12c03a32de419ff21bed71e0c5ef728fb682"),
#  > ide = "none",
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-02-17.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "e14b12c03a32de419ff21bed71e0c5ef728fb682";
        sha256 = "sha256-1tOvcdLX5UASFshpZNcC7fDy3n7naZKUZzy5IlOwHoQ=";
      };
