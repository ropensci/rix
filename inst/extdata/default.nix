# This file was generated by the {rix} R package v0.13.0 on 2024-11-19
# with following call:
# >rix(r_ver = "976fa3369d722e76f37c77493d99829540d43845",
#  > git_pkgs = list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "2705f89d7d0ede2d45c60145cb7223c6cf91678c"),
#  > ide = "other",
  ...
  git_archive_pkgs = [
    (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "2705f89d7d0ede2d45c60145cb7223c6cf91678c";
        sha256 = "sha256-omBIQ14sqmJzFqyhttJcI6zjJrzbfqzVakupiY8Q7TY=";
      };
