# This file was generated by the {rix} R package v0.17.3 on 2026-01-10
# with following call:
# >rix(date = "2025-04-29",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "4ef44e76922bda0bdcd2e47207757f11fa22db16"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-04-29.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "4ef44e76922bda0bdcd2e47207757f11fa22db16";
        sha256 = "sha256-CM/pEyq2fdvbuo3riGrCcyYJBVrjoB9zTFJkyWq0K7I=";
      };
