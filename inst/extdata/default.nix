# This file was generated by the {rix} R package v0.18.2 on 2026-03-23
# with following call:
# >rix(date = "2026-01-14",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "54cc78c02578a27a6f5a79e3a61bfaff804214c3"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2026-01-14.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "54cc78c02578a27a6f5a79e3a61bfaff804214c3";
        sha256 = "sha256-qOK9MAcPxyrcwvmJS5vw2ZkYNLAO4hK0mDi1Hu7Z2gg=";
      };
