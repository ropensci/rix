# This file was generated by the {rix} R package v0.15.5 on 2025-03-03
# with following call:
# >rix(date = "2025-02-28",
#  > git_pkgs = list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "c31ca9a39d386985f8ef78eb4dff67a836926f03"),
#  > ide = "none",
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-02-28.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "c31ca9a39d386985f8ef78eb4dff67a836926f03";
        sha256 = "sha256-gtRtcDdBGB36PJidLzwLNu9jLyRhInu3GqTZYOC8DOg=";
      };
