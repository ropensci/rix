# This file was generated by the {rix} R package v0.15.8 on 2025-04-18
# with following call:
# >rix(date = "2025-02-28",
#  > git_pkgs = list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "fccba913c0bf638d9b7910de7339a41d89e3c11d"),
#  > ide = "none",
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-02-28.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "fccba913c0bf638d9b7910de7339a41d89e3c11d";
        sha256 = "sha256-JlkW3bToKwxIDQTeYXMLAIHbhRREvzKEAz7Wh1vdZPQ=";
      };
