# This file was generated by the {rix} R package v0.17.0 on 2025-07-28
# with following call:
# >rix(date = "2025-04-29",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "44e92a682a4f8bdfec10ec9cb3281bfd36310404"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-04-29.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "44e92a682a4f8bdfec10ec9cb3281bfd36310404";
        sha256 = "sha256-n7NQxy0TrEZ/J7NuGhbmbDXUd2cDLVCLFu3RhMyHkOo=";
      };
