# This file was generated by the {rix} R package v0.17.3 on 2025-11-03
# with following call:
# >rix(date = "2025-04-29",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "5884a9cde10fc73432e14d2801bb123c957edf37"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-04-29.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "5884a9cde10fc73432e14d2801bb123c957edf37";
        sha256 = "sha256-obkXqDQoofnpb3ZFYqbtw7LCACzBRgfZT11kgiXhKBQ=";
      };
