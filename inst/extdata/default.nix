# This file was generated by the {rix} R package v0.14.6 on 2025-02-01
# with following call:
# >rix(date = "2025-01-27",
#  > git_pkgs = list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "05e282b303de1190827ff12f1654cdff9de50fbd"),
#  > ide = "other",
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-01-27.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "05e282b303de1190827ff12f1654cdff9de50fbd";
        sha256 = "sha256-bbb+JCqO1eE9R2XbxUXllxjLRF3TTYuskBincVp2P6Y=";
      };
