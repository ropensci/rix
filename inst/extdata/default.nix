# This file was generated by the {rix} R package v0.17.0 on 2025-06-27
# with following call:
# >rix(date = "2025-04-29",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "d1025dcca0b214541e23496c854a19d743f6b77d"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-04-29.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "d1025dcca0b214541e23496c854a19d743f6b77d";
        sha256 = "sha256-qe+ViQ/GKcI3PeR8rVE+DiCdkNFwibELtXPSspC/e68=";
      };
