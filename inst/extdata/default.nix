# This file was generated by the {rix} R package v0.18.2 on 2026-03-02
# with following call:
# >rix(date = "2026-01-14",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "db8977508da02dd0b7f08fce3646675c67757b25"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2026-01-14.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "db8977508da02dd0b7f08fce3646675c67757b25";
        sha256 = "sha256-LiUaJEevH5j+Lexq24fRIpK8Yw7qkOPK0QIyAmx2Jp8=";
      };
