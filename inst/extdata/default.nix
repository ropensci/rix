# This file was generated by the {rix} R package v0.18.2 on 2026-06-09
# with following call:
# >rix(date = "2026-04-30",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "71d2fbbd7344172370743fb8262fc805fe0280c1"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2026-04-30.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "71d2fbbd7344172370743fb8262fc805fe0280c1";
        sha256 = "sha256-M7D/4GqPdm629vL9EYlSHhlNmcW+XcX3WlCLj6eVMjA=";
      };
