# This file was generated by the {rix} R package v0.15.5 on 2025-03-01
# with following call:
# >rix(date = "2025-02-28",
#  > git_pkgs = list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "f6faf139c22eacf94a8d4b998b1d713ed8ec6abe"),
#  > ide = "none",
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-02-28.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "f6faf139c22eacf94a8d4b998b1d713ed8ec6abe";
        sha256 = "sha256-yqqeyKtYRlE9ddESVT1T7EToRBm+vGhIUyi+w5PlhUg=";
      };
