# This file was generated by the {rix} R package v0.15.5 on 2025-03-10
# with following call:
# >rix(date = "2025-02-28",
#  > git_pkgs = list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "761f7793269a44f98d5908f215349f97bee08e6f"),
#  > ide = "none",
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-02-28.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "761f7793269a44f98d5908f215349f97bee08e6f";
        sha256 = "sha256-ZDFpowKERK1wlxQiZ8u3WSO5U/g1U5rFueuQF+qQVSU=";
      };
