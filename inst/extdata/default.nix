# This file was generated by the {rix} R package v0.18.1 on 2026-02-04
# with following call:
# >rix(date = "2026-01-14",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "02adc4b1f45f059452054d41b86fee3212d74d2e"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2026-01-14.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "02adc4b1f45f059452054d41b86fee3212d74d2e";
        sha256 = "sha256-v0Jgh0eH9RzMPMWvXrIvcpH687DolFnQvCml9+gz5V0=";
      };
