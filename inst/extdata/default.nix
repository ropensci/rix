# This file was generated by the {rix} R package v0.18.2 on 2026-05-01
# with following call:
# >rix(date = "2026-01-14",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "f9885d766c1f9790136433d6c5307eacba2eb25c"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2026-01-14.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "f9885d766c1f9790136433d6c5307eacba2eb25c";
        sha256 = "sha256-IzsjDGzcBsIKn2WjHykL8/Xw9UdHUAEnV8VWKKml/Gg=";
      };
