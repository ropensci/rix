# This file was generated by the {rix} R package v0.18.2 on 2026-02-23
# with following call:
# >rix(date = "2026-01-14",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "b3f6be399f7ad3a202dc5adabab44c4f008ecbb9"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2026-01-14.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "b3f6be399f7ad3a202dc5adabab44c4f008ecbb9";
        sha256 = "sha256-XejpMdN1C63o6XQ1VNtIV2qpzko5ocUlpHmlsJcZAZ0=";
      };
