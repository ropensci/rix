# This file was generated by the {rix} R package v0.15.2 on 2025-02-25
# with following call:
# >rix(date = "2025-02-17",
#  > git_pkgs = list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "11fca1ce09e73cda45d97fe18be9050142dc3d48"),
#  > ide = "none",
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-02-17.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "11fca1ce09e73cda45d97fe18be9050142dc3d48";
        sha256 = "sha256-tZ0EGKpjuIbOyYD1U+oL6Wvea86/+hFob40KXj2+9yU=";
      };
