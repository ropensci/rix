# This file was generated by the {rix} R package v0.15.8 on 2025-03-31
# with following call:
# >rix(date = "2025-02-28",
#  > git_pkgs = list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "11bf042bb2f8f207da7a7b797206519982b74f09"),
#  > ide = "none",
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-02-28.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "11bf042bb2f8f207da7a7b797206519982b74f09";
        sha256 = "sha256-cOvRHolx/RwdfpeOHslmB1IwP5eJSezYF4NvX1PR0wA=";
      };
