# This file was generated by the {rix} R package v0.18.6 on 2026-09-23
# with following call:
# >rix(date = "2026-06-22",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "e8543ba1357f082d2ca9f8075e13f1316e10428d"),
  ...
  pkgs = import (fetchTarball {
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "e8543ba1357f082d2ca9f8075e13f1316e10428d";
        sha256 = "sha256-6idW6hDt2Co9tuzmcmEqGMeHIpMFlbdaA4UfU3lXtLI=";
      };
