# This file was generated by the {rix} R package v0.17.3 on 2025-12-22
# with following call:
# >rix(date = "2025-04-29",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "923b04bd8b3a149ccc1d7188155b0a78f967044f"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-04-29.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "923b04bd8b3a149ccc1d7188155b0a78f967044f";
        sha256 = "sha256-JDMnpiT0+gUyj5koFVUJzYkAg2okoK06+gMGfeMfm7g=";
      };
