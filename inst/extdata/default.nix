# This file was generated by the {rix} R package v0.13.5 on 2024-12-20
# with following call:
# >rix(r_ver = "976fa3369d722e76f37c77493d99829540d43845",
#  > git_pkgs = list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "b565393207ad9fdeb6b4b83f873fcd15f6ab1e3e"),
#  > ide = "other",
  ...
  git_archive_pkgs = [
    (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "b565393207ad9fdeb6b4b83f873fcd15f6ab1e3e";
        sha256 = "sha256-C9urp9YmABvpiuMNcHoeg4/iFsQZZSoNaNgk+l7tRRM=";
      };
