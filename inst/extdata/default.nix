# This file was generated by the {rix} R package v0.15.3 on 2025-02-28
# with following call:
# >rix(date = "2025-02-17",
#  > git_pkgs = list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "2fc3f29346e102086b00be77e81ad4cb13bfba98"),
#  > ide = "none",
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-02-17.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "2fc3f29346e102086b00be77e81ad4cb13bfba98";
        sha256 = "sha256-v4Ld4WKcARsvulPxZc7h9iJIpRbJ7PqRivIts8jx9SU=";
      };
