# This file was generated by the {rix} R package v0.17.3 on 2025-11-01
# with following call:
# >rix(date = "2025-04-29",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "1773dbb7113461f1b4deb69a4d2b62cb4c17a28a"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-04-29.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "1773dbb7113461f1b4deb69a4d2b62cb4c17a28a";
        sha256 = "sha256-ISIQr9+olyek9Ql0Nk5SzMbv/cLA+8Q5WaJ6arOMaik=";
      };
