# This file was generated by the {rix} R package v0.18.1 on 2026-02-02
# with following call:
# >rix(date = "2026-01-14",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "bb8bf0ff458c39beb2a43ed22ca37a7a444a33aa"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2026-01-14.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "bb8bf0ff458c39beb2a43ed22ca37a7a444a33aa";
        sha256 = "sha256-VLuGmBWzHFOIqfc2f0YI5zPrYwemPb/NIQGCHCzAJhA=";
      };
