# This file was generated by the {rix} R package v0.17.3 on 2025-11-10
# with following call:
# >rix(date = "2025-04-29",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "4853eccadc2f063704d0110e6436cd6ae816cdcc"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-04-29.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "4853eccadc2f063704d0110e6436cd6ae816cdcc";
        sha256 = "sha256-pSawZ/61pCJcqhJSs1bD/oCq+uATeAQsf0kYW8TzAQ0=";
      };
