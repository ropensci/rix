# This file was generated by the {rix} R package v0.18.2 on 2026-03-30
# with following call:
# >rix(date = "2026-01-14",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "7f95e17dc3262c55297a11fb10da06dd30461f65"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2026-01-14.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "7f95e17dc3262c55297a11fb10da06dd30461f65";
        sha256 = "sha256-onL1pPkhnfCUREvnH9Wt+RCabXivbftEh9SXa0z2Oxc=";
      };
