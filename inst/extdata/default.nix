# This file was generated by the {rix} R package v0.14.2 on 2025-01-03
# with following call:
# >rix(r_ver = "4.3.1",
#  > git_pkgs = list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "0c213d3893b41dd307e9e14cf6f69362b4621b48"),
#  > ide = "other",
  ...
  git_archive_pkgs = [
    (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "0c213d3893b41dd307e9e14cf6f69362b4621b48";
        sha256 = "sha256-1aiZVUHEyJoyq/XatPlm2iD5IkvQUdRcqCN/qtgMXkE=";
      };
