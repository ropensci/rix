# This file was generated by the {rix} R package v0.17.0 on 2025-07-07
# with following call:
# >rix(date = "2025-04-29",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "fca663ba288ae493125a8e3530429fd2dc35728e"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-04-29.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "fca663ba288ae493125a8e3530429fd2dc35728e";
        sha256 = "sha256-tqTaVPDWphtrHh/myTVaksqPDkDPkNwNQf+QE0nWlrU=";
      };
