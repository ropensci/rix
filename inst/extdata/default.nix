# This file was generated by the {rix} R package v0.17.0 on 2025-06-13
# with following call:
# >rix(date = "2025-04-29",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "62d7adbccfc7074812893fd37ecd39a6deb0d171"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-04-29.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "62d7adbccfc7074812893fd37ecd39a6deb0d171";
        sha256 = "sha256-Akjgv5pezAo/avcPIHZEejFv7RY6necHHE1cCK/bNzI=";
      };
