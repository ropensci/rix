...
environment so you don't need to use the temporary shell as explained above if
you want to add packages. Also, we don't recommend you update the date, unless
you specifically wish to do so and make sure your analysis' results remain
stable!
...
- [Compile a paper using Quarto and Nix on GitHub Actions](https://github.com/b-rodrigues/rix_paper)
